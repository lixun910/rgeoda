...
top_lit <- guerry_df['TopLit'][,1] # get 0/1 values of variable "top_lit"of variable "top_crm"

jc <- local_bijoincount(queen_w, top_crm, top_lit)
```
...
```{r}
bin_data <- guerry_df[c('TopWealth','TopWealth', 'TopLit')] # get 0/1 values of variable "TopWealth", "TopWealth" and "TopLit"
